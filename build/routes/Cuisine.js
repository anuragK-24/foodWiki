...
router.post(
  "/create",
  (0, ValidateSchema_1.ValidateSchema)(ValidateSchema_1.Schemas.cuisine.create),
  Cuisine_1.default.createCuisine
);
router.get("/get/:cuisineId", Cuisine_1.default.readCuisine);
router.get("/get", Cuisine_1.default.readAllCuisine);
router.patch(
  "/update/:cuisineId",
  (0, ValidateSchema_1.ValidateSchema)(ValidateSchema_1.Schemas.cuisine.update),
  Cuisine_1.default.updateCuisine
);
